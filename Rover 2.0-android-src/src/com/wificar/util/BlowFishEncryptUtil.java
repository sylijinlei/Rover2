...
public class BlowFishEncryptUtil   
{   
    ...
    public static void execute(){
        ...
        BlowFishEncryptUtil bf1 = new BlowFishEncryptUtil();
        
        bf1.init(true,keyByte);
        Log.d("wild0","en:"+ByteUtility.bytesToHex(str.getBytes()));
        //
        byte [] tt =bf1.encrypt(str);
        Log.d("wild0","decode:"+ByteUtility.bytesToHex(tt));
    
        BlowFishEncryptUtil bf2 = new BlowFishEncryptUtil();
        bf2.init(true,keyByte);
        Log.d("wild0", "en:"+ByteUtility.bytesToHex(bf2.decryptString(tt).getBytes()));
    ...
    public static byte[] execute(byte[] input, String key){
        ...
        //String str = "http://www.honglonglong.com";
        Log.d("wild0","key:"+key);
        Log.d("wild0","encode:"+ByteUtility.bytesToHex(input));
        ...
        //
        byte [] tt =bf1.encrypt(input);
        Log.d("wild0","decode:"+ByteUtility.bytesToHex(tt));
        
        BlowFishEncryptUtil bf2 = new BlowFishEncryptUtil();
        
        bf2.init(true,keyByte);
        byte [] hh =bf2.decryptBytes(tt);
        Log.d("wild0","encode:"+ByteUtility.bytesToHex(hh));
